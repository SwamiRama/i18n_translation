...
describe I18nTranslation::TranslateController do
  ...
  describe 'index' do
    ...
    def i18n_translations
      HashWithIndifferentAccess.new(en: {
                                      vendor: {
                                        foobar: 'Foo Baar'
                                      }
                                    },
    ...
    def files
      HashWithIndifferentAccess.new(:'home.page_title' => ['app/views/home/index.rhtml'],
  ...
  describe 'translate' do
    it 'should store translations to I18n backend and then write them to a YAML file' do
      ...
      I18nTranslation::Translate::Storage.should_receive(:new).with(:en).and_return(storage)
      log = double(:log)
      log.should_receive(:write_to_file)
      I18nTranslation::Translate::Log.should_receive(:new).with(:sv, :en, key_param.keys).and_return(log)
