...
describe I18nTranslation::Translate::TranslationFile do
  describe 'write' do
    ...
    it 'writes all I18n messages for a locale to YAML file' do
      ...
      expect(@file.read).to eq I18nTranslation::Translate::TranslationFile.deep_stringify_keys(translations)
    end
  ...
  describe 'deep_stringify_keys' do
    it 'should convert all keys in a hash to strings' do
      expect(I18nTranslation::Translate::TranslationFile.deep_stringify_keys(
               en: {
                 article: {
                   title: 'One Article'
                 },
